module.exports = {
	...
	execute(message, args) {
		...
		const choicePhrases = [
			...
			`I tried reading my tea leaves this morning. There was something about death and doom. Anyway, go with "${chosen}"`,
			`Eeny, meeny, miny, "${chosen}".`,
			`"${chosen}"'os, best choice for a complete breakfast!`,
